 ...
 */
function hyperion_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'hyperion' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'hyperion' ),
...
add_action( 'widgets_init', 'hyperion_widgets_init' );